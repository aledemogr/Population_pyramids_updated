...
options(scipen = 9)
setwd("/mywd/")
mydt  <-  read_csv("mydataset.csv")%>% filter(iso=='UGA')
```


Upload the dataset. You can find it on github [here](https://github.com/ghosthedirewolf/Population-graphs/blob/master/data_for_pyr.csv)
...
# select one administrative unit
newdf2 <- newdf1 %>%
